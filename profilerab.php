    ...
    <body style="background-color: ">
      ...
      <div style="background-color: ; height: 900px; width: auto;">
        <div style="background-color: ; height: 800px; width: auto;">
          <div style="background-image: url(img/hatw.png); background-size: 100% 100%; height: 700px; width: auto;">
            <div style="background-color: ; height: 700px; width: 1500px; margin-left: auto; display: flex; margin-right: auto;">
              ...
              <div style="background-color:; width: 500px; height: 700px;">
                ...
                <div style="background-color: ; height: 100%; width: 600px; margin-left: 15%; margin-top: 100px;">
                  <div style="background-image: url(img/statsrab.png); background-size: 100% 100%; height: 560px; width: 400px; ">
                    <div style="background-color: ; width: 300px; position: relative; height: 50px; top: 2%">
                      <h3 style="padding-left: 25px; top: 8%">Статистика</h3>
                    </div>
              ...
              <div style="background-color: ; width: 400px; height: 700px;">
               ...
               <div style="background-image: url(img/rabab.png); background-size: 100% 100%; position: relative; height: 300px; width: 350px;top: 50px; margin-top: 20px;">
                <div style="background-color: ; height: 40px; width: 270px; margin-left: auto; margin-right: auto; color: white; margin-top: 15px;">
                    <h2 class="pt-4"><?php echo $result["name"]?> </h2>
                </div>
                <div style="background-color: ; height: 150px; width: 270px; margin-left: auto; margin-right: auto; color: black; margin-top: 25px;" >
                  <form action="rabedit.php">
                   ...
                   <button style="background-image: url(btn.png); border: none; background-size: 100% 100%; border-radius: 50px; width: 140px; height: 30px;  font-size: 12px; margin-left: 20%; margin-top: 2%;">
                                <p style="color: white; font-size: 14px; padding-top: 3px; ">Написать</p> 
                    </button>
              ...
              <div style="background-color:; width: 500px; height: 600px; margin-left: auto;">

                <div style="background-color: ; height: 100%; width: 300px; margin-left: 5% ; margin-top: 100px">
                  <div style="background-image: url(img/bgw.png); background-size: 100% 100%; height: 560px; width: 400px; ">
                    ...
                    <div style="background-color: ; width: 280px; position: relative; height: 300px; top: 5%; left: 5%">
                      ...
                      <div style="background-color:; height: 100px; width: 280px; display: flex; margin-top: 10px;">
                        <div style="background-color: ; height: 100px; width: 100px; display: flex; margin-left: 15px; ">
                          <img  class="" src="https://d19m59y37dris4.cloudfront.net/university/1-1-1/img/teacher-4.jpg"  style="border-radius: 100%; height: 75px; width: 75px;">
                        
                      </div>
                      <div style="background-color: ; height: 100px; width: 100px;  margin-left: 20px;">
                        <div style="background-color: ; height: 20px; width: 180px;"><p style="margin-top: 10px;">Екатерина Иванова</p></div>
                        <div style="background-color: ; height: 20px; width: 100px;"><p style="margin-top: 5px;">Менеджер</p></div>
                      ...
                      <div style="background-color:; height: 100px; width: 280px; display: flex; margin-top: 10px;">
                        <div style="background-color: ; height: 100px; width: 100px; display: flex; margin-left: 15px; ">
                          <img  class="" src="p2.jpg" style="border-radius: 100%; height: 75px; width: 75px;">
                        
                      </div>
                      <div style="background-color: ; height: 100px; width: 100px;  margin-left: 20px;">
                        <div style="background-color: ; height: 20px; width: 180px;"><p style="margin-top: 10px;">Григорий Иванов</p></div>
                        <div style="background-color: ; height: 20px; width: 100px;"><p style="margin-top: 5px;">Back-end Разработчик</p></div>
                      ...
                      <div style="background-color:; height: 100px; width: 280px; display: flex; margin-top: 10px;">
                        <div style="background-color: ; height: 100px; width: 100px; display: flex; margin-left: 15px; ">
                          <img  class="" src="p1.jpg" style="border-radius: 100%; height: 75px; width: 75px;">
                        
                      </div>
                      <div style="background-color: ; height: 100px; width: 100px;  margin-left: 20px;">
                        <div style="background-color: ; height: 20px; width: 180px;"><p style="margin-top: 10px;">Александр Белов</p></div>
                        <div style="background-color: ; height: 20px; width: 100px;"><p style="margin-top: 5px;">Front-end</p></div>
            ...
            <div style="background-color: ; height: 100%; width: 300px; ">
                  <div style="background-image: url(img/bgw.png); background-size: 100% 100%; height: 100%; width: 300px; ">
                    ...
                    <div style="background-color:  ; width: 300px; position: relative; height: 30px; top: 8%; left: 10%">
                       ...
                       <form action="planrab.php" method="POST" method="POST" enctype="multipart/form-data">
                      <p style="margin-top: 30px;">1.С 9 до 12 концепт UI</p>
                      <p style="margin-top: 30px;">2.С 12 до 13 обед</p>
                      <p style="margin-top: 30px;">3.С 14 до 18 презентация</p>
            ...
            <div style="background-color: ; height: 100%; width: 300px; ">
                  <div style="background-image: url(img/bgw.png); background-size: 100% 100%; height: 100%; width: 300px; ">
                    ...
                    <div style="background-color:  ; width: 300px; position: relative; height: 30px; top: 8%; left: 10%">
                       ...
                       <form action="planrab.php" method="POST" method="POST" enctype="multipart/form-data">
                      <p style="margin-top: 30px;">1.Доработка профиля UI</p>
                      <p style="margin-top: 30px;">2.Обед до 13</p>
                      <p style="margin-top: 30px;">3.Доработка профиля UI</p>
                      <p style="margin-top: 30px;">4.</p>
                      <p style="margin-top: 30px;">5.</p>
                      <p style="margin-top: 30px;">6.</p>
            ...
            <div style="background-color: ; height: 100%; width: 300px; ">
                  <div style="background-image: url(img/bgw.png); background-size: 100% 100%; height: 100%; width: 300px; ">
                    ...
                    <div style="background-color:  ; width: 300px; position: relative; height: 30px; top: 8%; left: 10%">
                       ...
                       <form action="planrab.php" method="POST" method="POST" enctype="multipart/form-data">
                      <p style="margin-top: 30px;">1.С 9 до 12 доделать профиль</p>
                      <p style="margin-top: 30px;">2.Нужно сделать лого </p>
                      <p style="margin-top: 30px;">3.Буду доделывать прототип с 14</p>
                      <p style="margin-top: 30px;">4.</p>
                      <p style="margin-top: 30px;">5.</p>
                      <p style="margin-top: 30px;">6.</p>
...
$(document).on('scroll', function(){
    if ( $(window).scrollTop() > 30) {
        document.querySelector(".main-header").style.backgroundImage = "url(img/header.png)";
    } else {
