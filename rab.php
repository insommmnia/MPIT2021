          ...
          <div style="background-image: url(img/hatw.png); background-size: 100% 100%; height: 400px; width: auto;">
            <div style="background-color: ; height: 700px; width: 1500px; margin-left: auto; display: flex; margin-right: auto;">
              <div style="margin-left: 2%;">
               <div style="background-image: url(<?php echo $result['img']; ?>); background-size: 100% 100%; position: relative; height: 300px; width: 300px;top: 100px; border-radius: 100%;">
               ...
               <div>
               <div style="background-color: ; position: relative; height: 620px; width: 1100px;top: 100px; margin-left: 5%; display: flex;">
                 <div style="background-color: ; height: 100%; width: 450px; ">
                  <div style="background-image: url(img/bgw.png); background-size: 100% 100%; height: 100%; width: 300px; ">
                    <div style="background-color: ; width: 300px; position: relative; height: 50px; top: 5%">
                      <h4 style="padding-left: 5px; top: 15%;font-size: 23px;">18 Апреля
                       <?php 
                        if($result3["ready"] == 0)
                        {
                          echo "Не выполнено";
                    ...
                    <div style="background-color: ; width: 200px; position: relative; height: 200px; top: 5%; left: 15%">
              ...
              <div style="background-color: ; height: 100%; width: 300px; margin-left: 5% ; margin-top: 0px">
                  <div style="background-image: url(img/bgw.png); background-size: 100% 100%; height: 100%; width: 300px; ">
                    <div style="background-color: ; width: 300px; position: relative; height: 50px; top: 5%">
                      <h3 style="padding-left: 25px; top: 50px">Группа А</h3>
                    </div>
                    <div style="background-color: ; width: 280px; position: relative; height: 300px; top: 20px; left: 0%">
               ...
               <div style="background-color: ; height: 100%; width: 400px; margin-left: 5%">
                  <div style="background-image: url(img/statsrab.png); background-size: 100% 100%; height: 100%; width: 400px; ">
                    <div style="background-color: ; width: 300px; position: relative; height: 50px; top: 5%">
        ...
        <div style="background-color: ; width: 900px; height: 1000px; margin-left: 10px;">
          <div style="background-color: ; width: 900px; height: 500px; display: flex;">
            ...
            <div style="background-color: ; height: 100%; width: 300px; ">
                  <div style="background-image: url(img/bgw.png); background-size: 100% 100%; height: 100%; width: 300px; ">
                    <div style="background-color: ; width: 300px; position: relative; height: 50px; top: 5%">
                       <button class="btnp" style="border: none; margin-left: 5px;background: transparent;"><h4 style=" top: 15%; font-size: 23px;">18 Апреля 
                        <?php 
                        if($result3["ready"] == 0)
                        {
                          echo "Не выполнено";
            ...
            <div style="background-color: ; height: 100%; width: 300px; ">
                  <div style="background-image: url(img/bgw.png); background-size: 100% 100%; height: 100%; width: 300px; ">
                    ...
                    <div style="background-color:  ; width: 300px; position: relative; height: 30px; top: 8%; left: 15%">
                       ...
                       <form action="planrab.php" method="POST" method="POST" enctype="multipart/form-data">
                      <p style="margin-top: 30px;">1.9-14 Защита проекта </p>
                      <p style="margin-top: 30px;">2.15-18 свободен </p>
